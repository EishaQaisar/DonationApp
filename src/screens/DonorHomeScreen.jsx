...
import LanguageSwitcher from "../components/LanguageSwitcher" // We'll create this component
    ...
    <View style={[Styles.container, { marginBottom: tabBarHeight }]}>
      <ScrollView>
        <View style={Styles.banner}>
          <Image
            source={require("../../assets/items/donorp1.jpg")}
            style={{ opacity: 0.3, width: "100%", height: "100%", position: "relative" }}
          ></Image>
          <Text style={Styles.heroText1}>
            {t("donorHome.greeting")} {user.username}
          </Text>
          <View
            style={{
              flexDirection: "row",
        ...
        <View style={{ color: theme.colors.ivory }}>
          <Text style={[Styles.headings, { marginTop: 0 }]}>{t("donorHome.donations")}</Text>
        ...
        <View style={Styles.hero}>
          <View>
            ...
            />
            <Text style={Styles.heroText}>{t("donorHome.hero.title")}</Text>
            ...
            >
              <Text style={{ color: "white", fontSize: 16 }}>{t("donorHome.hero.button")}</Text>
            </Pressable>
          </View>
        </View>

        <Text style={[Styles.headings, { marginTop: 20 }]}>{t("donorHome.features.title")}</Text>

        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <TouchableOpacity onPress={() => navigation.navigate("ScheduleRDeliveryScreen")} style={Styles.optionCards}>
            <Image
            ...
            />
            <Text style={{ padding: 5, color: theme.colors.ivory }}>{t("donorHome.features.scheduleDelivery")}</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => navigation.navigate("DonorOrderTrackingScreen")} style={Styles.optionCards}>
            <Image
            ...
            />
            <Text style={{ padding: 5, color: theme.colors.ivory }}>{t("donorHome.features.monitorDelivery")}</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={() => navigation.navigate("DonorOrderTrcaking")} style={Styles.optionCards}>
            <Image
            ...
            />
            <Text style={{ padding: 5, color: theme.colors.ivory }}>{t("donorHome.features.viewAnalytics")}</Text>
          </TouchableOpacity>
        </ScrollView>
        <View
          style={{
        ...
        >
          <Text style={[Styles.headings, { marginTop: 0 }]}>{t("donorHome.campaigns.title")}</Text>
          <TouchableOpacity onPress={() => navigation.navigate("ViewNgoPostsScreen")}>
            <Text style={[Styles.viewAllButton, { marginTop: 0 }]}>{t("donorHome.campaigns.viewAll")}</Text>
          </TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {!loading && campaigns.length > 0 ? (
            ...
            <View style={Styles.CampCards}>
              <Text style={Styles.campaignTitle}>
                {loading ? t("donorHome.campaigns.loading") : t("donorHome.campaigns.noCampaigns")}
              </Text>
            </View>
          )}
        </ScrollView>
